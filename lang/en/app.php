...
return [
    ...
    'home' => [
        ...
        'select_agent_to_start' => 'Select an agent to start chatting.',
        'no_agents_available' => 'No agents are available to you yet.',
    ],
    ...
    'teacher' => [
        'agents' => [
            'manage_title' => 'Manage Agents',
            'agents' => 'Agents',
            'new_agent' => 'New Agent',
            'no_agents_yet' => 'No agents yet. Create one to get started.',
            ...
            'form' => [
                ...
                'instructions_placeholder' => 'Describe how the agent should behave…',
                ...
                'student_selectable_models_help' => 'Choose which OpenAI models students can pick for this agent. Sorted by overall estimated price per 1M tokens (cheapest first). Leave empty to always use the system default.',
                ...
                'monitoring_instructions_placeholder' => 'Describe how the monitoring agent should observe chats and when to use the ReportObservation tool…',
                'monitoring_help' => 'The monitoring function allows you to have the system observes the chat messages the student sends to this agent. This way you can identify notable events, such as smart questions, or moments where the student gets stuck.',
                'monitoring_model' => 'Model for Monitoring Agent',
                'use_system_default' => 'Use system default',

                'teacher_attachments' => 'Teacher Attachments',
                'attachments_help' => 'Upload documents that the AI can reference. Files are stored privately and also uploaded to the AI provider. Students’ chats with this agent will include these as attachments.',
