    ...
    <div class="mx-auto max-w-3xl w-full px-4 py-8">
        ...
        @if ($observations->isEmpty())
            <div
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('app.teacher.observations.no_observations_yet') }}
                </p>
            </div>
        @else
            <div
                ...
                @foreach ($observations as $o)
                    <a href="{{ route('teacher.observations.show', $o->id) }}"
                        class="block px-5 py-4 hover:bg-black/20 dark:hover:bg-white/20 transition-colors">
